...
def manage_students():
    students_list = ["Melanie", "Kamla", "Tawheed"]
    first_student= students_list[1]
    last_student = students_list[-1]
    return f"first student: {first_student} and last student {last_student}"
